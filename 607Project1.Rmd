...
# separate the column into three columns: Pair Number (Primary key), Name, and Total Points
...
# Change the primary key from character to intenger
chess_data_df$Player_Number <- as.integer(chess_data_df$Player_Number)

# separate the column into three columns: State, USCF_ID 
